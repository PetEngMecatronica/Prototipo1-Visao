...
def click_event1(event, x, y, flags, param):
    ...
    if event == cv2.EVENT_LBUTTONDOWN:
        ...
        print("AMARELO: (", hsv_color[0], ", ", hsv_color[1], ", ", hsv_color[2], ")")
...
def click_event2(event, x, y, flags, param):
    ...
    if event == cv2.EVENT_LBUTTONDOWN:
        ...
        print("ROSA: (", hsv_color[0], ", ", hsv_color[1], ", ", hsv_color[2], ")")
...
def click_event3(event, x, y, flags, param):
    ...
    if event == cv2.EVENT_LBUTTONDOWN:
        ...
        print("VERDE: (", hsv_color[0], ", ", hsv_color[1], ", ", hsv_color[2], ")")
...
def click_event4(event, x, y, flags, param):
    ...
    if event == cv2.EVENT_LBUTTONDOWN:
        ...
        # Define os limites com uma tolerância ao redor da cor clicada
        tolerance = 20
        lower_blue = np.array([(hsv_color[0] - tolerance), 100, 100])
        upper_blue = np.array([(hsv_color[0] + tolerance), 255, 170])

        print(f"Limites definidos: lower_blue={lower_blue}, upper_blue={upper_blue}")
        print("AZUL: (", hsv_color[0], ", ", hsv_color[1], ", ", hsv_color[2], ")")
...
def click_event(event, x, y, flags, param):
    ...
    if event == cv2.EVENT_LBUTTONDOWN:
        ...
        print("LARANJA: (", hsv_color[0], ", ", hsv_color[1], ", ", hsv_color[2], ")")
    ...
    while True:
        ...
        if ret:
            ...
            if lower_blue is not None and upper_blue is not None:
                ...
                #print(main_contours,  " AZUL ", main_mask)
                ...
                for contour in main_contours:
                    if cv2.contourArea(contour) > 100:
                        ...
                        if M["m00"] != 0:
                            ...
                            #print(secondary1_mask, " ROSA + AZUL ", secondary1_contours)
                            ...
                            #print(secondary2_mask, " AMARELO + AZUL ", secondary2_contours)
